...
WHERE products.discontinued='0' AND products.units_in_stock<25 AND categories.category_id=2
OR products.discontinued='0' AND products.units_in_stock<25 AND categories.category_id=4
...
WHERE order_details.quantity IN (SELECT quantity FROM order_details WHERE quantity=10)
